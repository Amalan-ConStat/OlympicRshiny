    ...
    fluidPage(theme = shinythemes::shinytheme("flatly"),
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  br(),
                  tags$img(src='www/Olympic.png', align= "center",height='75%',width='95%'),
                  br(),
                  ...
                  selectInput('NOC',"Choose Your Country:",
                              ...
                              selected = "Sri Lanka",selectize = FALSE,width='400px',size = 10),
                  br(),
                  h5("2. Click on *MEDAL GRAPH* tab to see how the medals were won
                  ...
                  br(),
                  h5("3. Show the data of the chosen country using *DATA* tab."),
                  br(),
